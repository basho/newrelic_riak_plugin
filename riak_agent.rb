  ...
  class Agent < NewRelic::Plugin::Agent::Base
    ...
    def setup_metrics
      ...
      @metrics = [
        ...
        Metric.new('vnode_gets', 'VNode/Gets/1Min', 'Operations'),
        Metric.new('vnode_puts', 'VNode/Puts/1Min', 'Operations'),
        ...
        Metric.new('node_gets', 'Node/Gets/1Min', 'Operations'),
        ...
        Metric.new('node_puts', 'Node/Puts/1Min', 'Operations'),
