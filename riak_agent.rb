  ...
  class Agent < NewRelic::Plugin::Agent::Base
    ...
    def setup_metrics
      ...
      @metrics = [
          ...
          Metric.new('vnode_index_reads', 'VNode/Index/Reads', 'Indexes/Seconds'),
          Metric.new('vnode_index_writes', 'VNode/Index/Writes', 'Indexes/Seconds'),
          Metric.new('vnode_index_deletes', 'VNode/Index/Deletes', 'Indexes/Seconds'),
          ...
          Metric.new('node_puts', 'Node/Puts', 'Operations/Seconds'),
          ...
          Metric.new('cpu_nprocs', 'CPU/Processes', 'Processes'),
          ...
          Metric.new('sys_process_count', 'Sys/Processes', 'Processes'),
          Metric.new('pbc_connects_total', 'PBC/Connections/Total', 'Connections'),
          Metric.new('pbc_connects', 'PBC/Connections', 'Connections/Seconds'),
          Metric.new('pbc_active', 'PBC/Connections/Active', 'Connections'),
          Metric.new('executing_mappers', 'Mappers/Executing', 'Mappers'),
          Metric.new('mem_total', 'Memory/Available', 'Bytes'),
          Metric.new('memory_total', 'Memory/Allocated', 'Bytes'),
          ...
          Metric.new('rings_reconciled', 'Rings/Reconciled', 'Rings/Seconds'),
